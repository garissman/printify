...
abstract class BaseStructure implements Arrayable, ArrayAccess, CanBeEscapedWhenCastToString, HasBroadcastChannel, Jsonable, JsonSerializable, QueueableEntity, Stringable, UrlRoutable
{
    use HasAttributes,
        HasEvents,
        HasGlobalScopes,
